...
async function cleanupSampleValues(keys, client) {
    ...
    try {
        for (var existingSettings_1 = __asyncValues(existingSettings), existingSettings_1_1; existingSettings_1_1 = await existingSettings_1.next(), !existingSettings_1_1.done;) {
            const setting = existingSettings_1_1.value;
        ...
        try {
            if (existingSettings_1_1 && !existingSettings_1_1.done && (_a = existingSettings_1.return)) await _a.call(existingSettings_1);
        }
