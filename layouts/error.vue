<template>
  <div class="container ">
    ...
    <ul>
      ...
      <li>Try searching for what you need in the site menu
      </li>
    </ul>

    <div class="roll-container">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 312.78 312.78" xml:space="preserve" x="0px" y="0px" class="die-roll">
        <g>
          <path d="M201.4,285.94c-29.92-12.17-59.86-24.31-89.76-36.56c-3.46-1.42-5.05-0.76-6.77,2.76
          ...
          <path d="M78.7,32.17c-1.08,1.57-1.76,2.49-2.35,3.45c-18.67,30.22-37.32,60.44-56.03,90.64
          ...
          <path d="M244.41,38.68c-0.28,0.06-0.57,0.11-0.85,0.17c5.95,35.83,11.94,71.66,17.79,107.51
          ...
          <path d="M107.59,68.63c0.67,56.52,1.33,111.9,2,168.22c48.39-28.41,95.66-56.17,143.54-84.29
            C204.43,124.48,156.6,96.9,107.59,68.63z"/>
          <path d="M236.45,287.59c3.67-25.43,7.5-50.84,11.28-76.25c2.59-17.37,5.2-34.73,7.93-53.01
          ...
          <path d="M101.4,70.64c-32.56,28.56-64.33,56.43-96.12,84.28c-2.74,2.4-2.23,4.2,0.47,6.31
            c27.4,21.48,54.74,43.05,82.11,64.56c4.74,3.73,9.57,7.34,15.49,11.88C102.69,181.28,102.05,126.38,101.4,70.64z"/>
          <path d="M234.02,19.48c-40.69,14.93-80.51,29.54-121.05,44.41c47.57,27.44,94.3,54.39,141.98,81.89
            C247.91,103.21,241.03,61.74,234.02,19.48z"/>
          <path d="M99.46,249.33c1.96-3.71,1.29-5.77-1.87-8.23c-29.41-22.93-58.72-45.99-88.06-69.01
            c-0.18,0.16-0.36,0.31-0.55,0.47c22.98,39.08,45.96,78.17,69.42,118.07C85.75,276.14,92.43,262.64,99.46,249.33z"/>
          <path d="M207.2,21.67c-40.73,2.41-81.46,4.82-123.05,7.29c6.84,9.56,13.21,18.22,19.29,27.08
          ...
          <path d="M249.27,269.5c18.18-33.4,36.37-66.8,54.54-100.18c0.36-0.65,0.72-1.31,1.08-1.96
