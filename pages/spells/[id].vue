<template>
  <section class="container docs-container">
    ...
    <div v-else>
      ...
      <p><label>Casting Time:</label> {{ spell.casting_time }} <span v-if="spell.ritual === 'yes'">{{ spell.ritual }}
          (Ritual)</span></p>
      <p><label>Duration:</label> {{ spell.duration }} <span v-if="spell.concentration === 'yes'">(Concentration)</span>
      </p>
