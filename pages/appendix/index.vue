<template>
  <section class="docs-container container">
    ...
    <div class="docs-toc">
      <ul>
        <nuxt-link tag="li" to="/characters/races/tiefling">
          Tiefling
        </nuxt-link>
        <nuxt-link tag="li" to="/characters/races/dragonborn">
          Dragonborn
        </nuxt-link>
        ...
        <nuxt-link tag="li" to="/characters/races/half-elf">
          Half-Elf
        </nuxt-link>
        <nuxt-link tag="li" to="/characters/races/half-orc">
          Half-Orc
        </nuxt-link>
        <nuxt-link tag="li" to="/characters/races/halfling">
          Halfling
        </nuxt-link>
